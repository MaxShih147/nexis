const CDN_PRIMARY = 'https://makio135.com/matcaps/1024'
const CDN_FALLBACK = 'https://cdn.jsdelivr.net/gh/nidorx/matcaps@master/1024'
const BACKEND = import.meta.env.VITE_BACKEND_URL || 'http://127.0.0.1:5179'

function mc(id) {
  return {
    id,
    thumb: `/matcaps/thumb/${id}.png`,
    urls: [
      `${CDN_PRIMARY}/${id}.png`,
      `${CDN_FALLBACK}/${id}.png`,
      `${BACKEND}/api/matcaps/${id}.png`,
    ],
  }
}

// Full matcap library from https://github.com/nidorx/matcaps
// Sorted by color category
export const MATCAP_GROUPS = [
  {
    labelKey: 'features.settings.matcapGroups.grey',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.white',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.silver',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.gold',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.brown',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.orange',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.red',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.yellow',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.olive',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.green',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.cyan',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.blue',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.purple',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.pink',
    items: [
  ...
  {
    labelKey: 'features.settings.matcapGroups.black',
    items: [
...
export const DEFAULT_MATCAP_ID = '626262_9E9E9E_848484_262626'
