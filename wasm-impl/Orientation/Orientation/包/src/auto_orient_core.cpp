...
namespace dao_core {
    ...
    int compute_auto_orientation_EulerXYZ_mod(
        ...
        if (module != 0 /* DAO_DENTAL_ORTHO */) return DAO_ERR_UNSUPPORTED_MODULE;
        ...
        //std::printf("[dao] result degree X %.5f  Y %.5f  Z %.5f\n", out_rad3[0]* rad2deg, out_rad3[1]* rad2deg, out_rad3[2] * rad2deg);
